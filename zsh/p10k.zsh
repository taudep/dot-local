# Generated by Powerlevel10k configuration wizard on 2025-12-22 at 22:37 EST.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    vcs                     # git status
    disc_secure             # DISC secure mode indicator
    # =========================[ Line #2 ]=========================
    newline                 # \n
  ...
  # Show a red "DISC Secure" indicator with a key icon when DISC_SECURE is set in the environment.
  function prompt_disc_secure() {
    [[ -n "$DISC_SECURE" ]] || return
    p10k segment -f red -b red -i '' -t 'DISC Secure'
  }

  function instant_prompt_disc_secure() {
    prompt_disc_secure
  }
